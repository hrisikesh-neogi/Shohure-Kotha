...
@cross_origin()
def admin_main_dash():
    """ For department heads and Admins.
    this will redirect to main login and dashboard pages."""

    return render_template('admin_main_dash.html')
...
def vocal():
    if "user" in session:
        ...
        if department != department_2:
            if department_2 != '' and department_2 != 'no':
